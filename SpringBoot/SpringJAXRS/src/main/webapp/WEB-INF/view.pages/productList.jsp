...
<!-- request.getContextPath() yerine pageContext.request.contextPath kullanilir -->
	...
	<section class="container">
		...
		<div class="col-md-6">
			<ul class="nav nav-tabs">
				...
				<li>
		<!-- <c:set var="productUrlCategory" value="${pageContext.request.contextPath}/products/category"/> -->
				<!-- http://localhost:8080/SpringMVCWeek3/products/category/laptop -->
					<a href="${productUrlCategory}/laptop">Laptops</a>
				</li>
				<li class="">
				<!-- http://localhost:8080/SpringMVCWeek3/products/category/tablet -->
